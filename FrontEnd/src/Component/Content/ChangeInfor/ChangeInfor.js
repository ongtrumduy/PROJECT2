...
import remove from "../../Image-Icon/Button White Remove.png";
...
export default class ChangePass extends React.Component {
  ...
  changePass = () => {
    return (
      <div
        className="change-infor-backgroundColor"
      ...
      >
        ...
        >
          <img
            onClick={() => this.cancelChangeInfor()}
            alt="cancel"
            src={remove}
          />
  ...
  render() {
    return <div>{this.changePass()}</div>;
  }
}
