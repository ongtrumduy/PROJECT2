...
import staron from "../../Image-Icon/Star On.png"
import staroff from "../../Image-Icon/Star Off.png";
import comment from "../../Image-Icon/Comment.png"
...
export default class Friend extends React.Component {
  ...
  Notify = (_lastname, _firstname, _date, _type) => {
    if (_type === "addfriend") {
      return <div>{this.addFriendNotify(_lastname, _firstname, _date)}</div>;
    } else if (_type === "agreeaddfriend") {
      return (
        <div>{this.agreeAddFriendNotify(_lastname, _firstname, _date)}</div>
      );
    } else if (_type === "becamefriend") {
      return <div>{this.becameFriendNotify(_lastname, _firstname, _date)}</div>;
    } else {
      return <div>{this.sentMessageNotify(_lastname, _firstname, _date)}</div>;
    }
  };
      ...
      <div className="notify-infor">
        ...
        <div className="notify-infor-content">
          ...
          <div className="notify-infor-bonus">
            <div className="notify-infor-icon">
              <img alt="user" src={users} />
            </div>
  ...
  render() {
    return (
      <div className="notify">
        ...
        <div className="notify-body">{this.renderNotifyList()}</div>
      </div>
    );
  }
}
